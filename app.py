...
@app.route('/newerrors')
def newerrors():
    return render_template('new_errors.html')
...
def run():
    # TODO:
    # run model
    err_count_arr, result, keyword = model.train_clus_model()
